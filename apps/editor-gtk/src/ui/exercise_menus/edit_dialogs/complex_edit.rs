...
use gtk4::prelude::*;
use gtk4::{
    Box as GtkBox, ComboBoxText, Dialog, DialogFlags, Label, Orientation, ResponseType, SpinButton,
};
use std::sync::{Arc, Mutex};
use weightlifting_core::RepsOrRange;

pub fn show_edit_complex_dialog(
    ...
    anchor_ex_entry.set_text(
        &complex
            .anchor_load
            .ex
            .unwrap_or_else(|| "SQUAT.BB.BACK".to_string()),
    );
