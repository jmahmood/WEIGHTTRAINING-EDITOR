...
use crate::ui::menus::{create_help_menu_button, create_main_menubar};
use glib::clone;
use gtk4::prelude::*;
use gtk4::{Application, ApplicationWindow, Box, Button, Orientation, Paned};
...
fn create_header_bar(state: Arc<Mutex<AppState>>, paths: Arc<AppPaths>) -> HeaderBar {
    ...
    // Initial sync from system and persist
    {
        ...
        app_state
            ...
            .sync_from_recent_manager(9, &["application/json"]);
