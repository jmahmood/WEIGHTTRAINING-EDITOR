...
use gtk4::prelude::*;
use gtk4::{Box, Orientation, Label, ScrolledWindow, Paned, Grid, Dialog, DialogFlags, ResponseType};
use weightlifting_core::{PlanDiff, PlanChange, ChangeType, DiffMetrics, PlanVersion};
use serde_json::json;
...
impl DiffDialog {
    ...
    fn create_metrics_section(metrics: &DiffMetrics) -> Box {
        ...
        // Additions
        let additions = Self::create_metric_card(
            "Additions",
            &metrics.additions.to_string(),
            "success"
        );
        ...
        // Deletions
        let deletions = Self::create_metric_card(
            "Deletions",
    ...
    fn create_comparison_section(diff: &PlanDiff) -> Box {
        ...
        let from_section = Self::create_version_section(
            "From Version",
        ...
        let to_section = Self::create_version_section(
            "To Version",
    ...
    fn create_version_section(title: &str, version: &str, _color: &str) -> Box {
        ...
        let json_placeholder = Label::builder()
            .label("JSON content would be displayed here\nwith syntax highlighting and diff markers")
