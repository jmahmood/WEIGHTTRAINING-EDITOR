...
use gtk4::prelude::*;
use gtk4::{Box, Orientation, Label, Button, Entry, SpinButton, ScrolledWindow, TextView};
use libadwaita::prelude::*;
use libadwaita::{ActionRow, PreferencesPage, PreferencesGroup};
use weightlifting_core::{SchemeTemplate, TopBackoffParams, TopSetParams, BackoffParams, IntensityParams};
...
impl SchemeCard {
    ...
    fn show_template_editor_dialog(exercise: &str) {
        ...
        let dialog = Dialog::with_buttons(
            ...
            DialogFlags::MODAL,
            &[("Cancel", ResponseType::Cancel), ("Apply", ResponseType::Apply)]
        );
        ...
        let intensity_entry = Entry::builder()
            .text("@8 RPE")
            .width_chars(15)
            .build();
